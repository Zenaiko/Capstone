    ...
    <div id="bs_inp_container">
        <div id="bs_inp_field">
            <div id="sign_bir">
                ...
                <input type="file" name="bir" id="bir" class="sign_bs_file seller_sign_img">
            </div>
            <hr>
            <div id="sign_dti">
                ...
                <input type="file" name="dti" id="dti" class="sign_bs_file seller_sign_img">
            </div>
            <hr>
            <div id="sign_sec">
                ...
                <input type="file" name="sec" id="sec" class="sign_bs_file seller_sign_img">
            </div>
            <hr>
            <div id="sign_mayor_perm">
                ...
                <input type="file" name="mayor_perm" id="mayor_perm" class="sign_bs_file seller_sign_img">
            </div>
            <?php 
            ...
            <div id="sign_fda">
                ...
                <input type="file" name="fda" id="fda" class="sign_bs_file seller_sign_img">
            </div>
            <?php } ?>
        </div>
    </div>
