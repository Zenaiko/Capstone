...
<form action="../db_api/db_seller_sign.php" method="post" id="shop_business_form">
    ...
    <div id="sign_agreement_container">
        <input type="radio" name="" id="agreement_terms_conditions"><label for="agreement_terms_conditions">I have read and agreed to the <a href="" id="terms_and_conditions">terms and conditions</a></label>
    </div>
